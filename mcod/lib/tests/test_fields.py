    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                ["something"],
                [{'match': {"title": {'query': "something"}}},
                 {'match': {"description": {'query': "something"}}}]
            ), (
                ["title", "description"],
                ["title|something", "description|anything"],
                [{'match': {"title": {'query': "something"}}},
                 {'match': {"description": {'query': "anything"}}}]
            ), (
                ["title", "description"],
                ["title|something", "anything"],
                [{'match': {"title": {'query': "something"}}},
                 {'match': {"title": {'query': "anything"}}},
                 {'match': {"description": {'query': "anything"}}}]
            ),
        ]
    )
...
class TestOrderingFilterField(object):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                {"id": "id", "date": None, "title": "title.raw"},
                ["_score"],
    ...
    def test_queryset(self, ordering_fields, default_ordering,
                      context, valid_query, es_dsl_queryset):
        fld = OrderingFilterField(ordering_fields=ordering_fields,
