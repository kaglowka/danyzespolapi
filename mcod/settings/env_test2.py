...
ALLOWED_HOSTS = ['test2.dane.gov.pl', 'admin.test2.dane.gov.pl', 'api.test2.dane.gov.pl']
...
NO_REPLY_EMAIL = 'no-reply@test2.dane.gov.pl'
...
BASE_URL = 'http://test2.dane.gov.pl'
PASSWORD_RESET_URL = 'http://test2.dane.gov.pl/user/reset-password/%s/'
EMAIL_VALIDATION_URL = 'http://test2.dane.gov.pl/user/verify-email/%s/'

PREVIEW_LINK_BASE = "http://test2.dane.gov.pl/"
