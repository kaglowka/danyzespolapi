...
ALLOWED_HOSTS = ['test.dane.gov.pl', 'admin.test.dane.gov.pl', 'api.test.dane.gov.pl']
...
NO_REPLY_EMAIL = 'no-reply@test.dane.gov.pl'
...
BASE_URL = 'http://test.dane.gov.pl'
PASSWORD_RESET_URL = 'http://test.dane.gov.pl/user/reset-password/%s/'
EMAIL_VALIDATION_URL = 'http://test.dane.gov.pl/user/verify-email/%s/'

PREVIEW_LINK_BASE = "http://test.dane.gov.pl/"
