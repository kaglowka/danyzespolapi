...
NO_REPLY_EMAIL = 'no-reply-preprod@dane.gov.pl'
...
BASE_URL = 'https://szkolenia.dane.gov.pl'
PASSWORD_RESET_URL = 'https://szkolenia.dane.gov.pl/user/reset-password/%s/'
EMAIL_VALIDATION_URL = 'https://szkolenia.dane.gov.pl/user/verify-email/%s/'

PREVIEW_LINK_BASE = "https://szkolenia.dane.gov.pl/"
