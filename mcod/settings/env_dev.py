...
NO_REPLY_EMAIL = 'no-reply@dev.dane.gov.pl'
...
BASE_URL = 'http://dev.dane.gov.pl'
PASSWORD_RESET_URL = 'http://dev.dane.gov.pl/user/reset-password/%s/'
EMAIL_VALIDATION_URL = 'http://dev.dane.gov.pl/user/verify-email/%s/'

PREVIEW_LINK_BASE = "http://dev.dane.gov.pl/"
