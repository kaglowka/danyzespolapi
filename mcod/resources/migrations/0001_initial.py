    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, max_length=2000, null=True,
                                          storage=mcod.lib.storages.ResourcesStorage(base_url=None, location=None),
                                          upload_to='', verbose_name='File')),
                ('format', models.CharField(blank=True, max_length=150, null=True, verbose_name='Format')),
                ...
                ('link', models.URLField(blank=True, max_length=2000, null=True, verbose_name='Resource Link')),
