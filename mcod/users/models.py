...
from mcod.lib.search.tasks import update_document
...
class User(AbstractBaseUser, PermissionsMixin, SoftDeletableModel, TimeStampedModel):
    ...
    customfields = JSONField(blank=True, null=True, verbose_name=_("About"))  # JSON - zmiana w modelu
...
# TODO: move following models to following app module
...
def es_refresh(sender, instance, *args, **kwargs):
    ...
    update_document.delay(resource._meta.app_label, resource._meta.object_name, resource.id)
